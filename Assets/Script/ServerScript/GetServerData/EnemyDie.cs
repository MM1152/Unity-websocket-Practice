...
public class EnemyDie : ISocket
{
    ...
    public override void RunNetworkCode(Data data)
    {
        ...
        bool isQuest = quest.QuestData.enemyType != 0 && quest.QuestData.enemyType == enemy.enemyData.type && data.this_player.id == socket.this_player.name;
        if(isQuest) quest.QuestData.count++;
