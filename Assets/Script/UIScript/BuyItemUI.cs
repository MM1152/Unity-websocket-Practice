...
public class BuyItemUI : MonoBehaviour
{
    ...
    public void Buy() {
        ...
        StartCoroutine(HttpRequest.HttpRequests.Request("http://localhost:8001/inventoryData", "id", Socket.Instance.this_player.name, (value) => inventoryData.ChangeMoney(value , this.gameObject)));
